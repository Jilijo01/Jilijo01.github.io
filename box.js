	...
	class Box extends HTMLElement {
		...
		render(val, info, color) {
			...
			if(rounded >=0 && rounded <=100) {
				...
				this.$svg.innerHTML = '<path d="M 950 500 A 450 450 0 0 0 50 500"></path>' + rounded + '%</text><text class="title" text-anchor="middle" alignment-baseline="middle" x="500" y="450" font-size="90" font-weight="normal">' + info + '</text><path d="' + x + '" class="data-arc"></path>"';
			}
		}
